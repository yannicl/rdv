...
@EnableWebMvc
@ComponentScan(basePackages = "com.yannic.rdv")
@ImportResource("classpath:/applicationContext-security.xml")
@EnableJpaRepositories("com.yannic.rdv.data.repository")
public class Application {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan(new String[] { "com.yannic.rdv.data.model" });
